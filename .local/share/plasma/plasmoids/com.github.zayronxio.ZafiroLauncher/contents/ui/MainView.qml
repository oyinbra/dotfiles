...
Item {
  ...
  readonly property color textColor: plasmoid.configuration.theming == 0 ? "#FFFFFF" : plasmoid.configuration.theming == 1 ? "#434c5e" : PlasmaCore.Theme.textColor
  ...
  Rectangle {
    ...
    color: plasmoid.configuration.theming == 0 ? "#2e3440" : plasmoid.configuration.theming == 1 ? "#ECEDEE" : PlasmaCore.Theme.backgroundColor
    radius: 10
    Rectangle {
      id: topCorner
      visible: true
  ...
  Item {
    Rectangle {
      ...
      radius: 6
      color: plasmoid.configuration.theming == 0 ? "#2e3440" : plasmoid.configuration.theming == 1 ? "#FFFFFF" : PlasmaCore.Theme.viewBackgroundColor
      Image {
        id: searchIcon
